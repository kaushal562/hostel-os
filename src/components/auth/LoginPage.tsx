...
const LoginPage = ({ variant = "page" }: { variant?: "page" | "embedded" }) => {
      ...
      >
        ...
        <div className="relative overflow-hidden rounded-[1.7rem] border border-white/10 bg-slate-950/82 px-6 py-7 sm:px-8 sm:py-9">
            ...
            <div>
              ...
              <h1 className="text-3xl font-semibold leading-[1.12] sm:text-4xl">
                <span className="bg-gradient-to-r from-cyan-100 via-indigo-100 to-purple-100 bg-clip-text text-transparent">
                  Enter Your Intelligent
                </span>
                <br />
                <span className="text-slate-100/95">Hostel Control Center</span>
              </h1>
              <p className="mt-4 max-w-md text-sm leading-relaxed text-slate-300/78 sm:text-[15px]">
                Securely sign in to continue with payments, complaints, notices,
                and your real-time student experience.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-[1.375rem]">
                ...
                <motion.div variants={MOTION.slideInUp} className="pt-3">
                  <PremiumButton
                    type="submit"
                    disabled={isLoading}
            ...
            <motion.div variants={MOTION.slideInUp} className="mt-6 space-y-4">
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <div className="h-px w-full bg-gradient-to-r from-transparent via-slate-500/70 to-transparent" />
                </div>
                <p className="relative mx-auto w-fit bg-slate-950/72 px-3 text-[11px] uppercase tracking-[0.14em] text-slate-500">
                  Secure zone
                </p>
              </div>
          ...
          >
            ...
            <div className="relative max-w-xl space-y-7 rounded-[2rem] p-8">
              ...
              <p className="max-w-lg text-[15px] leading-relaxed text-slate-300/78 xl:text-[17px]">
                A premium authentication experience designed to match your
                dashboard ecosystem with calm luxury, trust, and futuristic
                clarity.
              </p>
              <div className="grid max-w-md grid-cols-2 gap-3 text-[11px]">
                {["Realtime ecosystem", "End-to-end encrypted", "Fast role routing", "Enterprise-grade UX"].map((item) => (
                  <div
                    key={item}
